# Official Friendly Telegram Module
# Modded by cotik_
...
class AFKMod(loader.Module):
    """Module modded by cotik_ \n Вы можете встать в АФК, тем самым бот автоматически будет уведомлять тех, кто вам написал, что вы в ближайшее время не сможете ему ответить."""
    strings = {"name": "Custom AFK",
               "gone": "<b>🧡 Теперь я афк\nModded by cotik_</b>",
               "back": "<b>🧡 Я больше не афк\nModded by cotik_</b>",
               "afk": "<b>🧡 Я занят, не могу тебе ответить. \n Уже прошло {} .</b>",
               "afk_reason": "<b>🧡 Привет, да, я знаю, что ты хочешь что-то сказать этому человеку...\n🧡 Прости, но он не может тебе ответить.\n Уже прошло: </b> <i>{}</i> <b>.\n🧡 {} ."}

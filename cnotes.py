...
class NotesMod(loader.Module):
    ...
    strings_ru = {
        ...
        "_cmd_doc_save": "[папка] <имя> - Сохранить заметку",
        "_cmd_doc_note": "<имя> - Показать заметку",
        "_cmd_doc_delnote": "<имя> - Удалить заметку",
        "_cmd_doc_notes": "[папка] - Показать все заметки",
